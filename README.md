...
## 2. 新建angular項目
1. 新建一個名為myProject的項目
	>$ ng new myProject
2. 運行
	>$ ng serve --open
## 3. 新建組件
1. 在components文件夾下新建一個名為news的組件
...
## 4. 新建服務
1. 在services文件夾下創建一個名為storage的服務
	>$ ng g service services/storage
2. app.module.ts 裡面引入服務 並聲明
...
## 5. 雙向數據綁定
1. app.module.ts 引入表單相關模塊
 
	 	import { FormsModule } from '@angular/forms'; 

2. app.module.ts中聲明模塊
